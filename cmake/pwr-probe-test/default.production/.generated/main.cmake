...
add_executable(pwr_probe_test_default_image_NY8ttQuG ${pwr_probe_test_default_library_list})

set_target_properties(pwr_probe_test_default_image_NY8ttQuG PROPERTIES
    OUTPUT_NAME "default-production"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${pwr_probe_test_default_output_dir}")
target_link_libraries(pwr_probe_test_default_image_NY8ttQuG PRIVATE ${pwr_probe_test_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
pwr_probe_test_default_link_rule( pwr_probe_test_default_image_NY8ttQuG)

# Call bin2hex function from the rule file
pwr_probe_test_default_bin2hex_rule(pwr_probe_test_default_image_NY8ttQuG)
